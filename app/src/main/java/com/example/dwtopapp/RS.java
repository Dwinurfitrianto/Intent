...
public class RS extends ListActivity {
    protected void onCreate (Bundle icicle){
        ...
        String[] listRS = new String[] {"Rumah sakit Awal Bross", "RS Eka Hospitas", "RS Jiwa Tampan", "RS Tabrani"};
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            } else if (pilihan.equals("RS Eka Hospitas"))
            {
